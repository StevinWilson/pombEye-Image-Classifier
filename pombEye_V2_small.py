...
model = tf.keras.models.load_model(os.path.join(os.path.dirname(__file__), 'pombEye_mobilenetv2.h5'))
...
while True:
    ...
    try:
        ...
        test_image = image.load_img(os.path.join(os.path.dirname(__file__),'temp.jpg'), target_size = (224, 224))
